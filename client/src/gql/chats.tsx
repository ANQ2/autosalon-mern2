...
export const MY_CHATS = gql`
  query MyChats {
    myChats { id title lastMessageAt participants { id username role } }
  }
`;

export const CHAT = gql`
  query Chat($id: ID!) {
    chat(id: $id) { id title participants { id username role } }
  }
`;
...
export const SEND_MESSAGE = gql`
  mutation SendMessage($input: SendMessageInput!) {
    sendMessage(input: $input) { id text createdAt sender { id username } chat { id } }
  }
`;
