...
import type { Role } from "src/store/auth";
...
function AdminUsersInner() {
    const { data, loading, refetch } = useQuery<UsersQueryData>(USERS);
    const [setRole, { loading: saving }] = useMutation<unknown, SetUserRoleVars>(SET_USER_ROLE);
